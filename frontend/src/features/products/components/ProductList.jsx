                        ...
                        <Stack mb={'3rem'}>
                            ...
                            <Stack rowGap={5} mt={is600 ? 2 : 0}>
                                ...
                                <Stack
                                    ...
                                    columnGap={5}
                                    sx={{
                                        padding: '1rem', // Add padding inside the Stack
                                        marginRight: '9rem', // Adjust the right margin
                                        marginLeft: '1rem',  // Add left margin to keep it away from the edge
                                        marginTop: '2rem', // Add top margin for spacing from the top
                                        marginBottom: '1rem' // Add bottom margin for spacing from below
                                    }}
                                >
                                ...
                                {/* pagination */}
                                <Stack
                                    alignSelf={'center'}  // Center align the pagination stack
                                    rowGap={2}
                                    p={is488 ? 1 : 0}
                                    sx={{ width: '100%', justifyContent: 'center', alignItems: 'center' }}  // Ensure the Stack is centered
                                >
                                    <Pagination
